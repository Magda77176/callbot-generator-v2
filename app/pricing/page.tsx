...
const PLANS: Plan[] = [
  {
    ...
    features: ['1 000 min/mois inclus', 'Email + SMS', 'Google Calendar', 'Voix française'],
  },
  {
    id: 'pro',
    name: 'Pro',
    ...
    features: ['2 500 min/mois inclus', 'Tarif au-delà réduit', 'Enrichissement contextuel', 'Support prioritaire'],
  },
  {
    id: 'business',
    name: 'Business',
    ...
    features: ['6 000 min/mois inclus', 'Multi-bots inclus', 'Tarif au-delà optimal', 'Support dédié'],
  },
];
